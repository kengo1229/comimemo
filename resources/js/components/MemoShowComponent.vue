...
export default {
    ...
    methods: {
        getMemo() {
            axios.get('/api/memos/memo/' + this.memoId)
                .then((res) => {
                    this.memo = res.data,
        ...
        makeMemo() {
          ...
          */
          ...
          if (count > 0) {
            this.errMessage = '';
            axios.post('/api/memos/memo/make', this.secondaryMemo)
                  .then((res) => {
        ...
        updateMemo() {
            axios.put('/api/memos/memo/' + this.memoId, this.memo)
                  .then((res) => {
                      this.errMessages = {},
                      this.formFlg = false,
                      this.getMemo();
        ...
        deleteMemo() {
            axios.delete('/api/memos/memo/' + this.memoId)
                .then((res) => {
                    this.$router.push({name: 'memo.list'});
                });
        ...
        createMemoItem() {
            axios.post('/api/memos/memo/' + this.memoId, this.secondaryItem)
                .then((res) => {
                  this.errMessages = {},
                  this.secondaryItem = {},
                  this.getMemo();
        ...
        updateMemoItem() {
            axios.put('/api/memos/memo/' + this.memoId + '/item', this.item)
                  .then((res) => {
                    this.errMessages = {},
                    this.readonly = true,
                    this.disabled = true,
        ...
        deleteMemoItem(id) {
            axios.delete('/api/memos/memo/item/' + id)
                .then((res) => {
                    this.getMemo();
                });
        },
